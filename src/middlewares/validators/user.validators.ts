...
export const registrationValidation = [
    ...
    check("firstName", "firstName is required").not().isEmpty().withMessage("firstName is required"),
    check("lastName", "lastName is required").not().isEmpty().withMessage("lastName  is required"),
